  ...
  return (
    <section className="bg-background relative w-full overflow-hidden py-16 md:py-24">
      <div
        ...
        style={{
          background: `radial-gradient(circle at center, #C2F84F, transparent 70%)`,
        }}
      />
      <div
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="border-border/40 bg-secondary/20 mx-auto max-w-7xl overflow-hidden rounded-[28px] border shadow-xl backdrop-blur-sm">
